...
class Menu:
    ...
    def update(self):
        ...
        if ui.button(self.surface, 280, "START", click_sound=self.click_sound):
            return "game"

        if ui.button(self.surface, 390+BUTTONS_SIZES[1]*1.5, "Quit", click_sound=self.click_sound):
            pygame.quit()
            sys.exit()
